...
{
#ifdef VLOG
    fprintf(stderr, "Usage: %s [-h] <HCL file  >verilog file\n", name);
    fprintf(stderr, "Input HCL file on stdin, output verilog code on stdout.\n");
#else
    fprintf(stderr, "Usage: %s [-h] <HCL file  >C file\n", name);
    fprintf(stderr, "Input HCL file on stdin, output C file on stdout.\n");
#endif
